...
def check_str_to_date(str_date):
    ...
    Checks if an incoming string is a valid datetime
    """
    try:
...
def calculate_frequency_segment(total_orders):
    ...
    Calculates the value for the frequency segment
    based in the total orders of a customer
    """
    if 0 <= total_orders <= 4:
        return '0-4'
...
def calculate_recency_segment(last_order_ts):
    ...
    Calculates the value for the recency segment
    based in the last order date of a customer
    """
...
def calculate_datediff(last_order_ts):
    ...
    Calculates difference in days between income
    last order date and current date
    """
...
def get_voucher_amount(segment_name, segment_value):
    ...
    Uses spark to read the dataset generated by
    data pipeline, and look for the voucher amount
    regarding the incoming segment
    """
